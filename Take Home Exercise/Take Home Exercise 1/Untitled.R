...
folder_path <- "/Users/zishengwong/R Coding/ISSS626 Geospatial Analytics/Take Home Exercise/Take Home Exercise 1/data/aspatial/acra"
...
read_rds("data/rds/acra_data.rds")
